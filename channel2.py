...
def send_message():
    ...
    messages.insert(0, {'content':message['content'], 'sender':message['sender'], 'timestamp':message['timestamp'], 'channel_origin': 'emotion-channel'})
    ...
    messages.insert(0, {'content':emotions_message, 'sender': 'EmoBot', 'timestamp':datetime.datetime.now().isoformat(),  'channel_origin': 'emotion-channel'})
